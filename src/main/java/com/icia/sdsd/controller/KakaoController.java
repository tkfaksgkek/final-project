...
import com.icia.sdsd.dto.KakaoDTO;
import com.icia.sdsd.dto.MemberEntity;
import com.icia.sdsd.dto.MsgEntity;
import com.icia.sdsd.service.KakaoService;
...
public class KakaoController {
    ...
    public ResponseEntity<MsgEntity> callback(HttpServletRequest request) throws Exception {
        ...
        String email = kakaoInfo.getEmail(); // 카카오에서 얻어온 이메일
        String smNickname = kakaoInfo.getNickname(); // 카카오에서 얻어온 닉네임
        ...
        if (checkId.equals("OK")) {
            ...
            if(checkNick.equals("OK")){
                // 카카오 정보 데이터베이스에 저장
                memberService.saveKakaoMember(kakaoInfo);
                // 세션에 이메일과 닉네임 저장
                session.invalidate();
